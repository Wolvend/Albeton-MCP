...
describe("HyperNimbus Docker MCP profile plan", () => {
  ...
  it("keeps risky tools out of the HyperNimbus default allowlist", () => {
    ...
    expect(HYPERNIMBUS_SAFE_TOOL_ALLOWLIST).toContain("ableton_bridge_setup_status");
    ...
    expect(HYPERNIMBUS_SAFE_TOOL_ALLOWLIST).toContain("ableton_mcp_get_objective_readiness_report");
