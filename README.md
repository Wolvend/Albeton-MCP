...
| Concept-to-music | Turn a feeling, place, or liminal brief into a staged production plan, sample-search plan, mix plan, arrangement skeleton, and delivery plan. |
...
```text
Build: passed
Tests: 22 files, 70 tests passed
Lint: passed
...
MCP verifier: 191 tools, 3 resources, 2 prompts
All-tool contract sweep: 191 registered tools, 191 safe calls
