...
- Track and return-track creation, scene creation, clip creation, clip launch/stop, loop changes, renaming, track arm/mute/solo, track mixer volume/pan/send changes, return-track mixer volume/pan changes, and scene/clip duplication or movement.
