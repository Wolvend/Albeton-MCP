...
- Track and return-track creation, scene creation, clip creation, clip launch/stop, loop changes, clip gain, audio clip transpose/detune, audio clip warp settings, start/end marker changes, renaming, track arm/mute/solo, track mixer volume/pan/send changes, return-track mixer volume/pan changes, and scene/clip duplication or movement.
