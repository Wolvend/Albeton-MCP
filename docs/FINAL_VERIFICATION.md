...
Direct Streamable HTTP probe against `http://127.0.0.1:17366/mcp` reported `toolCount: 211`, `hasDeviceUiPlacement: true`, `hasDeviceCatalogMatches: true`, `hasRunbook: true`, `bootstrapIncludesDeviceUiPlacement: true`, `bootstrapIncludesDeviceCatalogMatches: true`, and `bootstrapIncludesRunbook: true`.
