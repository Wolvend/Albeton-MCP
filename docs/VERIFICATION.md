...
`npm run docker:hypernimbus:verify` should also report `expectedAllowedTools: 131`, `observedAllowedTools: 131`, and empty `missingSafeTools`, `unexpectedAbletonTools`, and `unexpectedRiskyTools` arrays.
