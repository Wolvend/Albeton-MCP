...
`npm run docker:hypernimbus:verify` should also report `expectedAllowedTools: 135`, `observedAllowedTools: 135`, and empty `missingSafeTools`, `unexpectedAbletonTools`, and `unexpectedRiskyTools` arrays.
