...
`npm run docker:hypernimbus:verify` should also report `expectedAllowedTools: 132`, `observedAllowedTools: 132`, and empty `missingSafeTools`, `unexpectedAbletonTools`, and `unexpectedRiskyTools` arrays.
