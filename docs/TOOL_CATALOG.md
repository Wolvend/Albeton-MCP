...
The server currently registers 244 MCP tools.
...
| Sample discovery/import | `ableton_list_free_sample_sources`, `ableton_search_free_sample_sources`, `ableton_plan_free_sample_download`, `ableton_search_internet_archive_audio`, `ableton_list_internet_archive_audio_files`, `ableton_search_freesound`, `ableton_download_sample`, `ableton_import_sample_to_library` |
