...
The server currently registers 173 MCP tools.
...
| Write-gated Live control | `ableton_set_tempo`, `ableton_create_clip`, `ableton_set_return_track_volume`, `ableton_set_device_parameter` |
