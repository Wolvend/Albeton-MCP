...
export function buildContractSweepCalls(fixtures: SweepFixtures): ContractSweepCall[] {
  ...
  return [
    ...
    { name: "ableton_set_tempo", arguments: bridgePayload() },
    { name: "ableton_transport_control", arguments: bridgePayload() },
    { name: "ableton_create_audio_track", arguments: bridgePayload() },
    { name: "ableton_create_midi_track", arguments: bridgePayload() },
    { name: "ableton_create_return_track", arguments: bridgePayload() },
    ...
    { name: "ableton_arm_track", arguments: bridgePayload() },
    { name: "ableton_mute_track", arguments: bridgePayload() },
    ...
    { name: "ableton_rename_clip", arguments: bridgePayload() },
    { name: "ableton_apply_groove", arguments: bridgePayload() },
