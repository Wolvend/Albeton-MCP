...
export const DOCKER_MCP_SAFE_TOOL_ALLOWLIST = [
  ...
  "ableton_generate_next_revision_pass",
  ...
  "ableton_classify_render_failure",
  "ableton_create_song_runbook",
  "ableton_plan_session_handoff",
  "ableton_validate_project_organization",
  ...
  "ableton_list_concept_execution_journals",
  "ableton_get_concept_execution_journal",
...
export const DOCKER_MCP_RISKY_TOOL_DENYLIST = [
  ...
  "ableton_create_source_manifest",
  "ableton_mark_source_as_user_provided",
  "ableton_mark_source_as_experiment_only",
  ...
  "ableton_switch_to_arrangement_view",
  "ableton_set_arrangement_time",
  "ableton_duplicate_session_clip_to_arrangement",
