...
- Foreground UI/mouse control is a separate ChromeDriver-style loopback driver fallback, not the default control path.
...
- UI driver command queue with timeout.
